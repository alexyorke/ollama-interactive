...
| `gemma4:e4b` | 8 local coding smoke cases | 8/8 pass on the latest July 1, 2026 serial local-small live gate; higher benchmark token total than Granite (`2436`) so it remains a comparison model |
| `qwen3:8b` | 8 local coding smoke cases | 8/8 pass on the latest July 1, 2026 serial local-small live gate, but higher token cost than Granite (`2532`) so it remains a comparison model rather than the default |
