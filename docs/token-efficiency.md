...
| `granite4.1:8b` | 8 local coding smoke cases | 8/8 pass on the latest June 29, 2026 serial local-small live gate; lowest benchmark token total of the three active local coding models (`2047`) so it remains the default |
...
| `qwen3:8b` | 8 local coding smoke cases | 8/8 pass on the latest June 29, 2026 serial local-small live gate, but higher token cost than Granite (`2534`) so it remains a comparison model rather than the default |
