...
- On the latest June 29, 2026 serial live gate, `granite4.1:8b`, `gemma4:e4b`, and `qwen3:8b` all passed `local-small`, and Granite stayed the default because it used the fewest benchmark tokens (`2047` vs `2435` and `2534`).
