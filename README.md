...
- On the latest July 1, 2026 serial live gate, `granite4.1:8b`, `gemma4:e4b`, and `qwen3:8b` all passed `local-small`, and Granite stayed the default because it won the benchmark token tie-break. Exact per-run totals live in `scratch/live-model-gate/live-model-gate-summary.json`.
