...
- On the latest July 1, 2026 serial live gate, `granite4.1:8b`, `gemma4:e4b`, and `qwen3:8b` all passed `local-small`, and Granite stayed the default because it used the fewest benchmark tokens (`2049` vs `2431` and `2533`).
