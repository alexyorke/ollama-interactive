...
TOOL_DESCRIPTIONS = [
    ...
    },
    {
        ...
        "description": "Search the installed Python stdlib/API index for current signatures, docstrings, and source locations; reranks top candidates with local Ollama embeddings when requested or OLLAMA_CODE_SDK_EMBED_MODEL is set.",
    },
    {
...
def format_compact_tool_help(tool_names: Iterable[str] | None = None) -> str:
    signatures = {
        ...
        "python_sdk_search": "python_sdk_search(query,limit=8,refresh=false,use_embeddings=false,embedding_model? or env OLLAMA_CODE_SDK_EMBED_MODEL)",
